#!/usr/bin/env bash
# Minimal EC2 bootstrap for a Docker Compose deployment of Shanyraq.
...
log "Creating /opt/shanyraq..."
install -d -m 0755 -o ubuntu -g ubuntu /opt/shanyraq
...
log "Then copy your .env file to /opt/shanyraq/.env and push to main."
